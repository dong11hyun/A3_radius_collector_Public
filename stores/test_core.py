    ...
    def test_4_boundary_address_validation(self):
        ...
        SEOUL_GU_BOUNDARIES = {
            ...
            '구로구': {'area_km2': 20.12, 'boundary': [
                ...
                (126.9053, 37.4822), (126.9016, 37.4775), (127.9010, 37.4761), (126.8969, 37.4757),
            ...
            '동대문구': {'area_km2': 14.22, 'boundary': [
                ...
                (127.0807, 37.5691), (127.0742, 37.5572), (127.0758, 37.5566), (127.0690, 37.5444),
                ...
                (127.0257, 37.5624), (127.0253, 37.5752)]},
